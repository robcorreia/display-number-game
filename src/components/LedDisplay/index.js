      ...
      <div style={{ display: "inline-block", position: "relative" }}>
        <svg width={+width + 4} height={+height} transform={skew}>
          <rect
            ...
            height={ledSize}
            style={{
              fill: `${(value & 1) === 1 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={barSize}
            style={{
              fill: `${(value & 2) === 2 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={ledSize}
            style={{
              fill: `${(value & 4) === 4 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={barSize}
            style={{
              fill: `${(value & 8) === 8 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={ledSize}
            style={{
              fill: `${(value & 16) === 16 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={barSize}
            style={{
              fill: `${(value & 32) === 32 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
          <rect
            ...
            height={barSize}
            style={{
              fill: `${(value & 64) === 64 ? foregroundCol : backgroundCol}`,
              stroke: borderCol,
              opacity: "0.8",
            }}
          />
